    ...
    div [ class "main-container" ] [
      div [ class "main-header" ] [
        ...
        , div [ class "header-buttons btn-technique", hidden (not model.hasWriteRights) ] [
          ...
          , button [ class "btn btn-success btn-save", disabled (isUnchanged || (not (isValid ui)) || ui.saving || String.isEmpty technique.name || not areBlockOnError || not areMethodsMissingParameters), onClick (CallApi (saveTechnique technique creation)) ] [ --ng-disabled="ui.editForm.$pending || ui.editForm.$invalid || CForm.form.$invalid || checkSelectedTechnique() || saving"  ng-click="saveTechnique()">
              text "Save "
